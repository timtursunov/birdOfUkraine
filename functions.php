...
if ( ! function_exists( 'birds_setup' ) ) :
	...
	function birds_setup() {
		 ...
		 * If you're building a theme based on birds, use a find and replace
...
function birds_scripts() {
	...
	wp_enqueue_style( 'bird-custom',  get_template_directory_uri() . '/css/custom.css' );
	
	wp_enqueue_script( 'birds-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'birds-script', get_template_directory_uri() . '/custom.js', array(), _S_VERSION, true );
